const CACHE_NAME = 'korean-flashstudy-v21';
const ASSETS = [
  './',
  './index.html',
...
self.addEventListener('fetch', event => {
  ...
  const isAudio = path.endsWith('.mp3') || path.endsWith('.m4a') || path.endsWith('.wav') || path.includes('/audios/') || path.includes('/audio/') || path.includes('/audio2/');
